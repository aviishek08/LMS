        ...
        <div className='p-6'>
          ...
          <form onSubmit={handleAddBook}>
            ...
            <div className='mb-4'>
              ...
              <input type="number" value={price} onChange={(e)=> setPrice(e.target.value)} placeholder="Book Price" 
              className='w-full px-4 py-2 border-2 border-black rounded-md' required/>
            </div>
            <div className='mb-4'>
              <label className="block text-gray-900 font-medium">Quantity</label>
              <input type="number" value={quantity} onChange={(e)=> setQuantity(e.target.value)} placeholder="Book Quantity" 
              className='w-full px-4 py-2 border-2 border-black rounded-md' required/>
            </div>
            <div className='mb-4'>
            ...
            <div className='flex justify-end space-x-4'>
              <button className='px-4 py-2 bg-gray-200 rounded-medium hover:bg-gray-300' type='button' onClick={()=>{
